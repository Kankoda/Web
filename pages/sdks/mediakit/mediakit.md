...
{{sdk.name}} is a Swift SDK that lets create amazing streaming media apps in Swift and SwiftUI. It has a configurable VideoPlayer and lets you add a video splash screen to present when the app launches. 
